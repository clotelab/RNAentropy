 ...
 */
INLINE  PUBLIC int E_IntLoop(int n1,
                              int n2,
                              int type,
                              int type_2,
                              int si1,
 ...
 */
INLINE  PUBLIC int E_Hairpin(int size,
                              int type,
                              int si1,
                              int sj1,
                              const char *string,
...
#################################
*/
INLINE  PUBLIC int E_Hairpin(int size, int type, int si1, int sj1, const char *string, paramT *P){
  int energy;
...
INLINE  PUBLIC int E_IntLoop(int n1, int n2, int type, int type_2, int si1, int sj1, int sp1, int sq1, paramT *P){
